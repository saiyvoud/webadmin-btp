        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                try {
                    ...
                    const response = await updateCoverImageApi(id, data);
                    if (response) {
                        Swal.fire({
                            title: "ບັນທຶກສຳເລັດ!",
                            icon: "success"
                            ...
                            <div className="border-2 border-dashed border-gray-300 rounded-lg h-[300px] w-full text-center p-2">
                                {image ? (
                                    <div className='w-full h-full relative'>
                                        <img src={fileImg ? image : `https://saiyfonbroker.s3.ap-southeast-1.amazonaws.com/images/${image}`} alt="Preview" className="w-full h-full object-cover rounded-lg" />
